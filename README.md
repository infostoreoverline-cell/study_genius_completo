...
Gli schemi complessi possono essere rifiutati da alcuni endpoint Gemini: in quel caso l'adattatore riprova in modalità JSON, fornisce il contratto nel prompt e applica comunque tutta la validazione locale. Il tentativo aggiuntivo conta nel limite di chiamate; l'esito di compatibilità viene però ricordato per versione e modello, così i progetti successivi non ripetono la stessa prova fallita.
