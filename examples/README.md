...
- **collaudo-live-qualita.json**: dettagli di copertura, valutazioni dei modelli, osservazioni tipografiche e consumi registrati.
- **demo-gas-ideale.pdf**: contenuti dimostrativi prestabiliti, compilati realmente ma senza chiamate API.

Leggi [il rapporto di collaudo](../docs/COLLAUDO.md) per distinguere ciò che è stato verificato dalle limitazioni residue.
